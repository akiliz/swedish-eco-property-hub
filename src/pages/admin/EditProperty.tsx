                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription>
                                  Keep your title under 60 characters for optimal SEO
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription>
                                  Keep your description between 120-160 characters
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input 
                                    placeholder="e.g. sustainable home, stockholm, eco-friendly" 
                                    {...field} 
                                  />
                                </FormControl>
                                <FormDescription>
